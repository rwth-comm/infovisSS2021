...
#Bayern
parties_by <- c("CSU", "SPD", "AfD", "FDP", "GRÜNE", "DIE LINKE")
perc_votes_by <- c(38.8, 15.3, 12.4, 10.2, 9.8, 6.1)


#Berlin
parties_b <- c("CDU", "DIE LINKE", "SPD", "GRÜNE" , "AfD", "FDP")
...
# Hessen
parties_H <- c("CDU", "SPD", "AFD", "FDP", "GRÜNE", "DIE LINKE")
perc_votes_H <- c(30.9, 23.5, 11.9, 11.5, 9.7, 8.1)

# Mecklenburg-Vorpommern

parties_MV <- c("CDU", "AFD", "DIE LINKE", "SPD", "FDP", "GRÜNE")
perc_votes_MV <- c(33.1, 18.6, 17.8, 15.1, 6.2, 4.3)

# Niedersachsen
parties_NS <- c("CDU", "SPD", "FDP", "AfD", "GRÜNE", "DIE LINKE")
...
parties_BR <- c("CDU", "AFD", "SPD", "DIE LINKE", "FDP", "GRÜNE" )
...
parties_bm <- c("SPD", "CDU", "DIE LINKE", "GRÜNE", "AfD", "FDP")
...
parties_HH <- c("CDU", "SPD", "GRÜNE", "DIE LINKE", "FDP", "AFD")
...
parties_NW <- c("CDU", "SPD", "FDP", "AfD", "GRÜNE", "DIE LINKE")
...
parties_RP <- c("CDU", "SPD", "AfD", "FDP", "GRÜNE", "DIE LINKE")
...
parties_SL <- c("CDU", "SPD", "DIE LINKE", "AfD", "FDP", "GRÜNE")
...
parties_S <- c("AfD","CDU", "DIE LINKE", "SPD", "FDP", "GRÜNE")
...
parties_SA <- c("CDU","AfD", "DIE LINKE", "SPD", "FDP", "GRÜNE")
...
parties_SH <- c("CDU", "SPD", "FDP", "GRÜNE", "AfD", "DIE LINKE")
...
parties_T <- c("CDU", "AfD", "DIE LINKE", "SPD", "FDP", "GRÜNE")
...
plot_Thüringen <- ggplot(pie_data_T) +
  aes(
    x0 = 0, y0 = 0, r0 = 0.4, r = 1,
    start = start_angle, end = end_angle,
    fill = parties_T
...
ggsave(plot_Schleswig_Holstein_transparent, filename = "ergebnis_Schleswig_Holstein.png",  bg = "transparent")

plot_Thüringen_transparent <- plot_Thüringen +
  theme(
    panel.background = element_rect(fill = "transparent"), # bg of the panel
    plot.background = element_rect(fill = "transparent", color = NA), # bg of the plot
    panel.grid.major = element_blank(), # get rid of major grid
...
plot_Thüringen_transparent

ggsave(plot_Thüringen_transparent, filename = "ergebnis_Thüringen.png",  bg = "transparent")
