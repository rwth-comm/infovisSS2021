...
p_bw <- ggplot(bw_pie_data)+
  ...
  geom_text(aes( #place amount inside the pie
      x = 0.7 * sin(mid_angle),
      y = 0.7 * cos(mid_angle),
      label = bw_perc_votes, fill=bw_parties), colour= "white")+
  geom_text(aes( #place names outside of the pie
      x = 1.05 * sin(mid_angle),
      y = 1.05 * cos(mid_angle),
      label = bw_parties,
      hjust = hjust, vjust = vjust))+
  scale_fill_manual(values= c(CDU = "#0C0C0C", SPD= "#E4000F", Gruene= "#65A22C", FDP= "#FEED01", AfD= "#009DE0", Linke="#E90098"))+
  theme_void()+
...
p_bay <- ggplot(bay_pie_data)+
  ...
  geom_text(aes( #place amount inside the pie
      x = 0.7 * sin(mid_angle),
      y = 0.7 * cos(mid_angle),
      label = bay_perc_votes, fill=bay_parties), colour= "white")+
  geom_text(aes( #place names outside of the pie
      x = 1.05 * sin(mid_angle),
      y = 1.05 * cos(mid_angle),
      label = bay_parties,
      hjust = hjust, vjust = vjust))+
  scale_fill_manual(values= c(CSU = "#0C0C0C", SPD= "#E4000F", Gruene= "#65A22C", FDP= "#FEED01", AfD= "#009DE0", Linke="#E90098"))+
  theme_void()+
  theme(legend.position = "none",
        plot.title = element_text(hjust = 0.5, size = 28))+
  coord_fixed(xlim = c(-1.2, 1.2))+
...
p_t <- ggplot(t_pie_data)+
  ...
  geom_text(aes( #place amount inside the pie
      x = 0.7 * sin(mid_angle),
      y = 0.7 * cos(mid_angle),
      label = t_perc_votes, fill=t_parties), colour= "white")+
  geom_text(aes( #place names outside of the pie
      x = 1.05 * sin(mid_angle),
      y = 1.05 * cos(mid_angle),
      label = t_parties,
...
p_nrw <- ggplot(nrw_pie_data)+
  ...
  geom_text(aes( #place amount inside the pie
      x = 0.7 * sin(mid_angle),
      y = 0.7 * cos(mid_angle),
      label = nrw_perc_votes, fill=nrw_parties), colour= "white")+
  geom_text(aes( #place names outside of the pie
      x = 1.05 * sin(mid_angle),
      y = 1.05 * cos(mid_angle),
      label = nrw_parties,
...
p_s <- ggplot(s_pie_data)+
  ...
  geom_text(aes( #place amount inside the pie
      x = 0.7 * sin(mid_angle),
      y = 0.7 * cos(mid_angle),
      label = s_perc_votes, fill=s_parties), colour= "white")+
  geom_text(aes( #place names outside of the pie
      x = 1.05 * sin(mid_angle),
      y = 1.05 * cos(mid_angle),
      label = s_parties,
...
p_ber <- ggplot(ber_pie_data)+
  ...
  geom_text(aes( #place amount inside the pie
      x = 0.7 * sin(mid_angle),
      y = 0.7 * cos(mid_angle),
      label = ber_perc_votes, fill=ber_parties), colour= "white")+
  geom_text(aes( #place names outside of the pie
      x = 1.05 * sin(mid_angle),
      y = 1.05 * cos(mid_angle),
      label = bw_parties,
...
p_bran <- ggplot(bran_pie_data)+
  ...
  geom_text(aes( #place amount inside the pie
      x = 0.7 * sin(mid_angle),
      y = 0.7 * cos(mid_angle),
      label = bran_perc_votes, fill=bran_parties), colour= "white")+
  geom_text(aes( #place names outside of the pie
      x = 1.05 * sin(mid_angle),
      y = 1.05 * cos(mid_angle),
      label = bran_parties,
...
p_brem <- ggplot(brem_pie_data)+
  ...
  geom_text(aes( #place amount inside the pie
      x = 0.7 * sin(mid_angle),
      y = 0.7 * cos(mid_angle),
      label = brem_perc_votes, fill=brem_parties), colour= "white")+
  geom_text(aes( #place names outside of the pie
      x = 1.05 * sin(mid_angle),
      y = 1.05 * cos(mid_angle),
      label = brem_parties,
...
p_ham <- ggplot(ham_pie_data)+
  ...
  geom_text(aes( #place amount inside the pie
      x = 0.7 * sin(mid_angle),
      y = 0.7 * cos(mid_angle),
      label = ham_perc_votes, fill=ham_parties), colour= "white")+
  geom_text(aes( #place names outside of the pie
      x = 1.05 * sin(mid_angle),
      y = 1.05 * cos(mid_angle),
      label = ham_parties,
...
p_hes <- ggplot(hes_pie_data)+
  ...
  geom_text(aes( #place amount inside the pie
      x = 0.7 * sin(mid_angle),
      y = 0.7 * cos(mid_angle),
      label = hes_perc_votes, fill=hes_parties), colour= "white")+
  geom_text(aes( #place names outside of the pie
      x = 1.05 * sin(mid_angle),
      y = 1.05 * cos(mid_angle),
      label = hes_parties,
...
p_nied <- ggplot(nied_pie_data)+
  ...
  geom_text(aes( #place amount inside the pie
      x = 0.7 * sin(mid_angle),
      y = 0.7 * cos(mid_angle),
      label = nied_perc_votes, fill=nied_parties), colour= "white")+
  geom_text(aes( #place names outside of the pie
      x = 1.05 * sin(mid_angle),
      y = 1.05 * cos(mid_angle),
      label = nied_parties,
...
p_rpf <- ggplot(rpf_pie_data)+
  ...
  geom_text(aes( #place amount inside the pie
      x = 0.7 * sin(mid_angle),
      y = 0.7 * cos(mid_angle),
      label = rpf_perc_votes, fill=rpf_parties), colour= "white")+
  geom_text(aes( #place names outside of the pie
      x = 1.05 * sin(mid_angle),
      y = 1.05 * cos(mid_angle),
      label = rpf_parties,
...
p_saar <- ggplot(saar_pie_data)+
  ...
  geom_text(aes( #place amount inside the pie
      x = 0.7 * sin(mid_angle),
      y = 0.7 * cos(mid_angle),
      label = saar_perc_votes, fill=saar_parties), colour= "white")+
  geom_text(aes( #place names outside of the pie
      x = 1.05 * sin(mid_angle),
      y = 1.05 * cos(mid_angle),
      label = saar_parties,
...
p_sa <- ggplot(sa_pie_data)+
  ...
  geom_text(aes( #place amount inside the pie
      x = 0.7 * sin(mid_angle),
      y = 0.7 * cos(mid_angle),
      label = sa_perc_votes, fill=sa_parties), colour= "white")+
  geom_text(aes( #place names outside of the pie
      x = 1.05 * sin(mid_angle),
      y = 1.05 * cos(mid_angle),
      label = sa_parties,
...
p_sh <- ggplot(sh_pie_data)+
  ...
  geom_text(aes( #place amount inside the pie
      x = 0.7 * sin(mid_angle),
      y = 0.7 * cos(mid_angle),
      label = sh_perc_votes, fill=rpf_parties), colour= "white")+
  geom_text(aes( #place names outside of the pie
      x = 1.05 * sin(mid_angle),
      y = 1.05 * cos(mid_angle),
      label = sh_parties,
...
p_mv <- ggplot(mv_pie_data)+
  ...
  geom_text(aes( #place amount inside the pie
      x = 0.7 * sin(mid_angle),
      y = 0.7 * cos(mid_angle),
      label = mv_perc_votes, fill=mv_parties), colour= "white")+
  geom_text(aes( #place names outside of the pie
      x = 1.05 * sin(mid_angle),
      y = 1.05 * cos(mid_angle),
      label = mv_parties,
